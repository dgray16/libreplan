...
public class CalendarImporterMPXJ implements ICalendarImporter {
    ...
    private BaseCalendar toBaseCalendar(CalendarDTO calendarDTO, BaseCalendar parent) throws InstanceNotFoundException {
        ...
        List<CalendarData> calendarDatas = getCalendarDatas(calendarDTO.calendarWeeks, parent);

        BaseCalendar baseCalendar = BaseCalendar.createUnvalidated(code, name, parent, calendarExceptions, calendarDatas);
     ...
     */
    private List<CalendarData> getCalendarDatas(List<CalendarWeekDTO> calendarWeeks, BaseCalendar parent) {
    ...
    private CalendarException toCalendarException(
            CalendarExceptionDTO calendarExceptionDTO) throws InstanceNotFoundException {
    ...
    private CalendarData toCalendarData(CalendarWeekDTO workingWeek, BaseCalendar parent) {
        ...
        Map<Integer, Capacity> capacitiesPerDays = getCapacitiesPerDays(workingWeek.hoursPerDays, parent);
        try {
