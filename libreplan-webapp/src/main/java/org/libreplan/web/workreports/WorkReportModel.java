...
public class WorkReportModel extends IntegrationEntityModel implements IWorkReportModel {
    ...
    public void remove(WorkReport workReport) {
        ...
        try {
            ...
            sumChargedEffortDAO.updateRelatedSumChargedEffortWithDeletedWorkReportLineSet(
                    workReport.getWorkReportLines());
    ...
    public List<Object> getFieldsAndLabelsLineByDefault() {
        return getWorkReport() != null ? sort(getWorkReportType().getLineFieldsAndLabels()) : new ArrayList<>();
    }
    ...
    private Integer getAssignedLabelIndex(Label label) {
        Set<WorkReportLabelTypeAssignment> assignments = getWorkReportType().getWorkReportLabelTypeAssignments();

        for (WorkReportLabelTypeAssignment labelTypeAssigment : assignments) {
    ...
    public Set<IntegrationEntity> getChildren() {
        return (Set<IntegrationEntity>) (workReport != null ? workReport.getWorkReportLines() :
